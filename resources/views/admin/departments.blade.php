            ...
            <div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px">
                <div class="mdk-drawer-layout__content page">
                    ...
                    <div class="container-fluid page__container">
                         ...
                         <h2 class="bold m-4 text-center p-4">Departments</h2>
                         @if(session('success'))
                         <div class="alert alert-success" role="alert">
                            <strong>Success! </strong> you have added a new Department!
                        </div>
                         @endif
                         <ul class="sidebar-menu mt-0">
                            ...
                            @foreach($depts as $dept)
                                <div class="col-sm-4">
                                    <div class="card" >
                                        <img src="{{ asset('/images/crmc.jpg') }}" class="card-img-top" style="width: 100%; height: 15vw; object-fit: cover;" alt="crmc_logo">
                                        <div class="card-body">
                                            <h5 class="card-title"><a href={{"departments/".$dept['id']}}>{{$dept['department_name']}}</a></h5>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-center-title">Create new Department</h5>
                ...
                <div class="modal-body">
                    ...
                    @csrf
                        <div class="form-group">
                            ...
                            <input type="text" name="dept_name" class="form-control"  placeholder="Name of Department">
                        </div>
                        <!-- <div class="form-group">
                                        <label for="select01">Coordinator:</label>
                                        <select id="select01" name="dept_coordinator" data-toggle="select" class="form-control">
                                            <option selected>N/A</option>
                                            <option>Erica Salve</option>
                                            <option>Jerome Dichos</option>
                                        </select>
                        </div> -->
