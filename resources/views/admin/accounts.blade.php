                         ...
                         <div class="card">
                                    ...
                                    <div class="card-body tab-content">
                                        <div class="tab-pane active show fade" id="activity_all">
                                            <table id="coordinators" class="table mb-0 thead-border-top-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                    <th scope="row">1152RT3</th>
                                                    <td>Mark Allen</td>
                                                    <td>Computer Science</td>
                                                    <td>Coordinator</td>
                                                    </tr>
                                                    <tr>
                                                    <th scope="row">1182ZT1</th>
                                                    <td>Jacob Lee</td>
                                                    <td>Psychology</td>
                                                    <td>Coordinator</td>
                                                    </tr>
                                                    <tr>
                                                    <th scope="row">1252BZ3</th>
                                                    <td>Larry Burnham</td>
                                                    <td>Criminology</td>
                                                    <td>Coordinator</td>
                                                    </tr>
                ...
                <div class="col-lg-12 card-body">
                                    ...
                                    <div class="form-row">
                                            ...
                                            <div class="form-group">
                                                <label for="select01">Department: </label>
                                                <select id="select01" name="course" data-toggle="select" class="form-control">
                                                    @foreach($depts as $dept)
                                                    <option value="dept here" selected>{{$dept['department_name']}}</option>
                                                    @endforeach
                                                </select>                  
                                        </div>
